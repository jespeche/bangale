...
dependencies {
    ...
    implementation("com.graphql-java-kickstart:graphql-java-servlet:7.5.0")
    implementation("com.graphql-java-kickstart:graphql-java-tools:5.4.0")
    implementation("com.graphql-java:graphql-java:11.0")
    implementation("com.graphql-java:graphql-java-extended-scalars:1.0")

    runtimeOnly("com.graphql-java-kickstart:graphiql-spring-boot-starter:5.9.0") { because("Embedded Graphql IDE") }
    runtimeOnly("com.graphql-java-kickstart:voyager-spring-boot-starter:5.9.0") { because("Embedded schema navigation") }
